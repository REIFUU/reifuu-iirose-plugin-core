    ...
    function createConfigElement(plugin) {
        ...
        configList.forEach(item => {
            if (typeof plugin.config[item] == "object") {
                ...
                box.append(createConfigItem(schema, item));
            }
        });
        return box;
    }
    ...
    function createConfigItem(schema, title) {
        ...
        switch (schema.type) {
            ...
            case "boolean": {
                ...
                boolean.setAttribute("style", "height:27px;width: 150px;display: flex;align-items:center;justify-content:flex-end;margin: 0 12px;");
                
                const inputDiv = document.createElement("div");
                inputDiv.setAttribute("style", "display: flex;align-items:center;justify-content:flex-start;border-radius:13px;height:70%;width: 42%;padding: 4px 6px;text-align: center;background-color: #4c4c52;");

                const ball = document.createElement("div")
                ball.setAttribute("style","height:23px;width:23px;border-radius:12px;background-color: #252529;")
